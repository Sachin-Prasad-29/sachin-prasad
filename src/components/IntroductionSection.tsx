        ...
        <section id='hero'>
            <div className='experience container hero container fadein'>
                <div className='col-left'>
                    ...
                    <p style={styleTwo}>I build interactive websites that run across platforms and devices.</p>
                    <div className='btn'>
                        <button className='btn-resume'>
                            <a
                                ...
                                rel='noreferrer'
                            >
                                Resume&emsp;<i className='fa-solid fa-circle-down'></i>
                            </a>
                        </button>
                    </div>
                    <a href='#about' className='no-select'>
                        <svg className='mouse stagger1' width='20' height='40' viewBox='0 0 40 77'>
                ...
                <div className='col-right'>
                    <img className='avatar'  alt='my-cartoon-avatar' />
                </div>
            </div>
        </section>
    )
